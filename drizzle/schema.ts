...
export const mindMemories = mysqlTable(
  "mind_memories",
  {
    ...
    retirementReason: varchar("retirementReason", { length: 320 }),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => [
...
export const videoJobs = mysqlTable(
  "video_jobs",
  {
    ...
    transcriptStorageKey: varchar("transcriptStorageKey", { length: 1024 }),
    transcriptFormat: mysqlEnum("transcriptFormat", ["txt", "srt", "vtt"]),
    transcriptCharacterCount: int("transcriptCharacterCount"),
